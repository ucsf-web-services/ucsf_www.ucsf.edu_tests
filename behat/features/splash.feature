    ...
    Feature:
      ...
      Scenario: See featured image
        Then I should see the image "/sites/default/files/styles/2014_front_page_carousel/public/field/image/news/dna-art.jpg?itok=IZnqVghN"

      @TBI
      Scenario: Follow link from image
        Then I should see the link "/news/2015/04/125111/california-launches-initiative-advance-precision-medicine"
